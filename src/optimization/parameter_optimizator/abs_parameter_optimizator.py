...
"""Parameter optimization class. Realization of this class realize strategy of parameter optimization
...
class absParameterOptimizator(ABC):
  ...
  def next(self,prev_run_report:SimulationReport)->Union[StrategyConfig, None]:
