...
class absSimulationReportStorage(ABC):
    ...
    def try_get(self, strategy_id: StrategyId, simulation_config: SimulationConfig) -> Union[SimulationReport, None]:
        ...
        Returns:
            Union[SimulationReport, None]: Finded report or None if not found
        """
        report = self._try_get(simulation_config)
    ...
    def try_add(self, strategy_id:StrategyId, simulation_config: SimulationConfig, simulation_report: SimulationReport) -> bool:
        ...
        Args:
            ...
            simulation_report (SimulationReport): run report
        """
    ...
    @abstractmethod
    def _try_add(self, strategy_id:StrategyId, simulation_config: SimulationConfig, simulation_report: SimulationReport) -> bool:
        """Logic of try_add

        Args:
            simulation_config (SimulationConfig): _description_
            simulation_report (SimulationReport): _description_
